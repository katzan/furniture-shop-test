...
privileged aspect ShopOrderDetailController_Roo_Controller {
    ...
    public String ShopOrderDetailController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
