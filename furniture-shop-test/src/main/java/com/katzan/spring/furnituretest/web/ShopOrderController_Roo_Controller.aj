...
privileged aspect ShopOrderController_Roo_Controller {
    ...
    public String ShopOrderController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
